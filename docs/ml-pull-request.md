...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops-poc-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://adb-8195009858693383.3.azuredatabricks.net#mlflow/models/staging-mlops-poc-model)
* [Prod workspace registered model](https://adb-4437901305756982.2.azuredatabricks.net#mlflow/models/prod-mlops-poc-model)
