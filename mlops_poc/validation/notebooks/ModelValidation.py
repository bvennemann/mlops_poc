...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``mlops_poc/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
dbutils.widgets.text("model_name", "dev-mlops-poc-model", "Model Name")
